                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-inner">
                                ...
                                <input type="text" name="title" id="title" placeholder='{{translate("Enter Title")}}' value="{{$page->title}}" required>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-inner">
                                ...
                                <input type="text" name="slug" id="slug" placeholder='{{translate("Enter Slug")}}' value="{{$page->slug}}">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-inner">
                                ...
                                <textarea id="description" class="tinymce-editor" name="description" cols="30" rows="10">{{$page->description}}</textarea>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-inner">
